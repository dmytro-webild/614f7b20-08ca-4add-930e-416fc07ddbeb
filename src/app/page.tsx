      ...
      features={[
        {
          ...
          description: "We provide a local business number for your ads, Google Profile, and website.",
          imageSrc: "http://img.b2bpic.net/free-photo/cute-text-messages-mobile-phone-screen-media-mix_53876-98453.jpg",
          imageAlt: "Step 1",
        },
        {
          title: "Calls ring through",
          description: "It rings your mobile exactly like a normal call. You lose no functionality.",
        ...
        },
        {
          ...
          description: "If you can't answer, we text the caller within 30 seconds asking how to help.",
      ...
      plans={[
        {
          ...
          features: [
            ...
            "Auto Text-back",
            "Unlimited Missed Call Tracking",
      ...
      testimonials={[
        {
          ...
          name: "John D.",
          handle: "@johnplumb",
          testimonial: "I never miss a quote anymore. Game changer.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Sarah W.",
          handle: "@sarahspark",
          testimonial: "My customers actually like the text-back feature.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Dave M.",
          handle: "@davegas",
          testimonial: "Easy setup. Recovered my first job within an hour.",
          rating: 5,
        ...
        },
        {
          id: "t4",
          name: "Elena R.",
          handle: "@elenaelectric",
          testimonial: "Professional, fast, and simple. Love it.",
          rating: 5,
